...
export const EN: UiText = {
  ...
  footer: {baseline: 'Quiz and domain content management platform.', version: 'Version', rights: '. All rights reserved.', privacyLink: 'Privacy'},
  home: {
  ...
  preferences: {
    ...
    notificationCategoryDomain: 'Domain notifications',
    notificationCategoryQuiz: 'Quiz notifications',
    notificationCategoryLms: 'LMS notifications',
