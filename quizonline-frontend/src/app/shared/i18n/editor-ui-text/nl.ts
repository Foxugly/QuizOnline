...
export const NL: EditorUiText = {
  ...EN,
  domainForm: {...EN.domainForm, titleRequired: 'Naam is verplicht.', joinPolicy: 'Domeintoetreding', joinPolicyAuto: 'Automatisch', joinPolicyOwner: 'Goedkeuring door de eigenaar', joinPolicyOwnerManagers: 'Goedkeuring door de eigenaar of een beheerder', joinPolicyHint: 'Hoe een gebruiker lid wordt van dit domein: automatisch of na goedkeuring.', publicLabel: 'Publiek', publicHint: 'Een privédomein staat niet in de catalogus: er wordt alleen via uitnodiging toegang verleend.'},
  ...
  questionForm: {...EN.questionForm, practice: 'Oefening', practiceHint: 'Vraag beschikbaar in snelle test-quizzen.', exam: 'Examen', examHint: 'Vraag voorbehouden voor examen-quizzen.'},
  ...
  pages: {
    ...
    subjectCreate: {...EN.pages.subjectCreate, title: 'Onderwerp maken', subtitle: 'Domeinkeuze en vertalingen'},
    subjectEdit: {...EN.pages.subjectEdit, title: 'Onderwerp bewerken', subtitle: 'Vertalingen en inhoud', questionsTitle: 'Vragen', addQuestion: 'Toevoegen', noQuestions: 'Geen vraag.', titleCol: 'Titel', actionsCol: 'Acties'},
    questionCreate: {
    ...
    questionEdit: {...EN.pages.questionEdit, title: 'Vraag bewerken', subtitle: 'Context, vertalingen en antwoorden'},
    questionView: {...EN.pages.questionView, title: 'Vraagdetails'},
    quizQuick: {...EN.pages.quizQuick, title: 'Snelle quiz', subtitle: 'Genereer een quizsessie vanuit een domein en doelonderwerpen.', submit: 'Quiz genereren'},
    quizCreate: {...EN.pages.quizCreate, back: 'Terug', cancel: 'Annuleren', loading: 'Laden...', createQuestionForTemplate: 'Een vraag maken voor dit template', createQuestionForQuiz: 'Een vraag maken voor deze quiz', createQuestion: 'Vraag maken'},
