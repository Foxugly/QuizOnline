...
export const NL: EditorUiText = {
  ...EN,
  domainForm: {...EN.domainForm, joinPolicy: 'Domeintoetreding', joinPolicyAuto: 'Automatisch', joinPolicyOwner: 'Goedkeuring door de eigenaar', joinPolicyOwnerManagers: 'Goedkeuring door de eigenaar of een beheerder', joinPolicyHint: 'Hoe een gebruiker lid wordt van dit domein: automatisch of na goedkeuring.'},
