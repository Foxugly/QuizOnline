...
export const IT: EditorUiText = {
  ...
  domainForm: {
    ...
    certificateBrandingLegend: 'Branding del certificato',
    certificateSignatoryName: 'Firmatario — nome',
    certificateSignatoryNamePlaceholder: 'es. Mario Rossi',
    certificateSignatoryNameHint: 'Nome stampato sotto la riga della firma sul PDF del certificato.',
    certificateSignatoryTitle: 'Firmatario — titolo',
    certificateSignatoryTitlePlaceholder: 'es. Presidente, Direttrice',
    certificateSignatoryTitleHint: 'Ruolo tradotto mostrato sotto il nome del firmatario (uno per lingua).',
    certificateLogo: 'Logo',
    certificateLogoUpload: 'Scegli un logo…',
    certificateLogoRemove: 'Rimuovi il logo',
    certificateLogoClearSelection: 'Annulla selezione',
    certificateLogoHint: 'In cima a ogni PDF di certificato emesso in questo dominio. Le proporzioni vengono mantenute.',
  },
  subjectForm: {
    ...EN.subjectForm,
    domain: 'Dominio',
  ...
  pages: {
    ...
    userDelete: {pageTitle: 'Elimina utente', irreversibleBadge: 'Irreversibile', confirmPrefix: 'Elimina', confirmSuffix: '?', userFallbackPrefix: 'Utente n°', errors: {invalidId: 'ID utente non valido.', loadFailed: 'Impossibile caricare questo utente.', deleteFailed: 'Impossibile eliminare questo utente.'}},
    ...
    quizSessionDelete: {pageTitle: 'Elimina quiz', introPrefix: 'Stai per eliminare il quiz', introSeparator: 'per', loading: 'Caricamento del quiz…', userFallbackPrefix: 'Utente n°', errors: {invalidId: 'ID quiz non valido.', loadFailed: 'Impossibile caricare il quiz.', deleteFailed: 'Eliminazione non possibile.'}},
    ...
    userList: {title: 'Utenti', subtitle: 'Gestione utenti', id: 'ID', username: 'Nome utente', name: 'Nome', email: 'Email', nbDomainMax: 'Max domini', active: 'Attivo', emailConfirmed: 'Email confermata', actions: 'Azioni', bulkActionsPlaceholder: 'Azioni di gruppo…', bulkActionsApply: 'Applica', selectedSingular: 'selezionato', selectedPlural: 'selezionati', searchPlaceholder: 'Cerca…'},
    quizTemplateResults: {
