...
export const IT: EditorUiText = {
  ...
  pages: {
    ...
    subjectCreate: {...EN.pages.subjectCreate, title: 'Crea argomento', subtitle: 'Scelta del dominio e traduzioni'},
    subjectEdit: {...EN.pages.subjectEdit, title: 'Modifica argomento', subtitle: 'Traduzioni e contenuto', questionsTitle: 'Domande', addQuestion: 'Aggiungi', noQuestions: 'Nessuna domanda.', titleCol: 'Titolo', actionsCol: 'Azioni'},
    questionCreate: {
    ...
    questionEdit: {...EN.pages.questionEdit, title: 'Modifica domanda', subtitle: 'Contesto, traduzioni e risposte'},
    questionView: {...EN.pages.questionView, title: 'Dettagli della domanda'},
    quizQuick: {...EN.pages.quizQuick, title: 'Quiz rapido', subtitle: 'Genera una sessione quiz da un dominio e da argomenti mirati.', submit: 'Genera quiz'},
    quizCreate: {...EN.pages.quizCreate, back: 'Indietro', cancel: 'Annulla', loading: 'Caricamento...', createQuestionForTemplate: 'Crea una domanda per questo template', createQuestionForQuiz: 'Crea una domanda per questo quiz', createQuestion: 'Crea domanda'},
