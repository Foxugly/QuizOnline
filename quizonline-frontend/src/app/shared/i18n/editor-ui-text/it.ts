...
export const IT: EditorUiText = {
  ...EN,
  domainForm: {...EN.domainForm, joinPolicy: 'Adesione al dominio', joinPolicyAuto: 'Automatica', joinPolicyOwner: 'Approvazione del proprietario', joinPolicyOwnerManagers: 'Approvazione del proprietario o di un gestore', joinPolicyHint: 'Come un utente diventa membro di questo dominio: automaticamente o previa approvazione.'},
