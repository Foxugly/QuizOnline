...
import {RichTextBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/rich-text-block-renderer';
import {ImageBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/image-block-renderer';
import {VideoBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/video-block-renderer';
import {FileBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/file-block-renderer';
import {QuizBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/quiz-block-renderer';
import {CalloutBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/callout-block-renderer';
import {CodeBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/code-block-renderer';
import {EmbedBlockRenderer} from '../../../pages/lms/lesson-view/block-renderers/embed-block-renderer';
 ...
 *
 * Used by both ``/lms/lesson/{id}`` (learner) and the preview mode
 * of ``/lms/lesson/{id}/edit`` (author) so the two views are
