 ...
 * ``/lms/course-invite/:token``. Surfaces the labels needed to render
 * "X has invited you to Y" plus the Accept / Decline CTAs and the
 * outcome / error messages.
 */
export interface LmsCourseInviteAcceptUiText {
  pageTitle: string;
...
export function getLmsCourseInviteAcceptUiText(
  lang: LanguageEnumDto | string | null | undefined,
): LmsCourseInviteAcceptUiText {
  switch (lang) {
