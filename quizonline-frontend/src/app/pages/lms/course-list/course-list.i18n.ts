 ...
 * ``/lms/course/list``. Mirrors the schema used by the other admin
 ...
 */
export interface LmsCourseListUiText {
  title: string;
...
const UI_TEXT: Record<LanguageEnumDto, LmsCourseListUiText> = {
...
export function getLmsCourseListUiText(
