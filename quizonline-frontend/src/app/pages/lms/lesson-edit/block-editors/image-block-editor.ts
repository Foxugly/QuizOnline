 ...
 * the renderer. The non-translatable ``image`` URL is read-only here;
 * a file picker that goes through :class:`LmsUploadService` is wired
 * in via a follow-up commit (T67) — keeping the upload concern out
 * of this commit means the editor compiles standalone.
 */
@Component({
