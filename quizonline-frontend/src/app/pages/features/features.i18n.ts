  ...
  sections: {
    ...
    learning: {
      ...
      features: {
        ...
        editor: {title: 'Éditeur drag-and-drop', description: 'Réorganisez les blocs d\'une leçon par glisser-déposer avec auto-save débouncé. Même UX pour les sections et leçons d\'un cours.'},
  ...
  sections: {
    ...
    learning: {
      ...
      features: {
        ...
        editor: {title: 'Drag-and-drop editor', description: 'Reorder blocks in a lesson by drag-and-drop with debounced auto-save. Same UX for sections and lessons inside a course.'},
  ...
  sections: {
    ...
    learning: {
      ...
      features: {
        ...
        editor: {title: 'Drag-and-drop editor', description: 'Herorden blokken in een les via drag-and-drop met gedebounced auto-save. Zelfde UX voor secties en lessen binnen een cursus.'},
  ...
  sections: {
    ...
    learning: {
      ...
      features: {
        ...
        editor: {title: 'Editor drag-and-drop', description: 'Riordina i blocchi di una lezione tramite drag-and-drop con auto-save debounced. Stessa UX per sezioni e lezioni di un corso.'},
  ...
  sections: {
    ...
    learning: {
      ...
      features: {
        ...
        editor: {title: 'Editor drag-and-drop', description: 'Reordena los bloques de una lección con arrastrar y soltar y auto-guardado debounced. Misma UX para secciones y lecciones de un curso.'},
