  ...
  sections: {
    ...
    enrollment: {
      ...
      features: {
        ...
        certificateConfig: {title: 'Certificats configurables', description: 'Activez ou désactivez l\'émission par cours, et définissez une durée de validité en mois. Date d\'expiration figée à l\'émission.'},
  ...
  sections: {
    ...
    enrollment: {
      ...
      features: {
        ...
        certificateConfig: {title: 'Configurable certificates', description: 'Toggle issuance per course and set a validity in months. The expiration date is frozen at issue time.'},
  ...
  sections: {
    ...
    enrollment: {
      ...
      features: {
        ...
        certificateConfig: {title: 'Configureerbare certificaten', description: 'Schakel de uitgifte per cursus aan of uit en stel een geldigheid in maanden in. De vervaldatum wordt bij uitgifte vastgezet.'},
  ...
  sections: {
    ...
    enrollment: {
      ...
      features: {
        ...
        certificateConfig: {title: 'Certificati configurabili', description: 'Attiva o disattiva l\'emissione per ogni corso e imposta una validità in mesi. La data di scadenza viene fissata al momento dell\'emissione.'},
  ...
  sections: {
    ...
    enrollment: {
      ...
      features: {
        ...
        certificateConfig: {title: 'Certificados configurables', description: 'Activa o desactiva la emisión por curso y define una validez en meses. La fecha de caducidad se congela al emitirse.'},
