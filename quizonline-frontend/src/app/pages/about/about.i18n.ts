...
const FR: AboutUiText = {
  ...
  features: [
    ...
    'Centre de messages pour suivre les actions et événements reliés aux quiz.',
  ],
...
const EN: AboutUiText = {
  ...
  features: [
    ...
    'Message center for tracking quiz-related events and actions.',
  ],
...
const IT: AboutUiText = {
  ...
  features: [
    ...
    'Centro messaggi per tracciare eventi e azioni legati ai quiz.',
  ],
...
const ES: AboutUiText = {
  ...
  features: [
    ...
    'Centro de mensajes para seguir eventos y acciones relacionados con los cuestionarios.',
  ],
