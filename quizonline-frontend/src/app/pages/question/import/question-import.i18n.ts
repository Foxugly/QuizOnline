...
const FR: QuestionImportUiText = {
  ...
  subtitle: "Importez un fichier JSON structuré contenant un domain, des subjects et des questions multilingues.",
  back: 'Retour',
  ...
  validationTitle: 'Vérification du format',
  ...
  domainObjectError: 'Le fichier doit contenir une clé "domain" avec un objet.',
  subjectsArrayError: 'Le fichier doit contenir une clé "subjects" avec une liste.',
  questionsArrayError: 'Le fichier doit contenir une clé "questions" avec une liste.',
  ...
  questionSubjectsReferenceError: (item) => `Question ${item}: un subject référencé n'existe pas dans "subjects".`,
  questionDomainError: (item) => `Question ${item}: "domain" doit être un entier positif.`,
  ...
  questionSubjectsError: (item) => `Question ${item}: "subject_ids" doit être une liste d'entiers positifs.`,
  questionMediaError: (item) => `Question ${item}: "media_asset_ids" doit être une liste d'entiers positifs.`,
  questionAnswersError: (item) => `Question ${item}: il faut au moins 2 réponses dans "answer_options".`,
  questionCorrectAnswerError: (item) => `Question ${item}: il faut au moins une réponse correcte.`,
  answerShapeError: (item, answer) => `Question ${item}, réponse ${answer}: format invalide.`,
  answerTranslationsError: (item, answer) => `Question ${item}, réponse ${answer}: "translations" doit contenir au moins une langue.`,
  answerTranslationShapeError: (item, answer, lang) => `Question ${item}, réponse ${answer}, langue "${lang}": contenu invalide.`,
  fileValidated: (count) => `${count} question(s) prête(s) à être importée(s).`,
  importLabel: 'Importer',
  cancelLabel: 'Annuler',
  importDone: 'Import terminé',
  importSuccess: (count) => `${count} question(s) importée(s) avec succès.`,
  importPartialTitle: 'Import incomplet',
  importPartialMessage: (success, failed) => `${success} question(s) importée(s), ${failed} en erreur.`,
  importFailure: (item) => `La question ${item} n'a pas pu être importée.`,
};

const EN: QuestionImportUiText = {
  title: 'Question Import',
  subtitle: 'Import a structured JSON file containing a domain, topics, and multilingual questions.',
  back: 'Back',
  ...
  exampleDescription: 'Download a sample JSON file (one domain, one topic, and one multilingual question). Adapt it to your data before importing.',
  ...
  subjectObjectError: (item) => `Topic ${item}: invalid format.`,
  questionObjectError: (item) => `Question ${item}: invalid format.`,
  questionSubjectsReferenceError: (item) => `Question ${item}: a referenced topic is missing from "subjects".`,
