...
- Bouton « Créer un cours » en haut à droite de `/lms/catalog`.
- Bouton « Liste » en haut à droite de `/lms/catalog`, qui mène à `/lms/course/list`.
- Petit crayon en haut à droite de chaque card de cours dans `/lms/catalog` pour les cours que vous gérez.
- Tag « Publié » / « Brouillon » sur chaque card et sur `/lms/course/<slug>` quand vous pouvez gérer.

![Screenshot : catalogue vu d'un instructeur](screenshots/instructor-01-catalog-instructor.png)

## 2. Créer un cours

Depuis le catalogue, cliquez sur « Créer un cours » en haut à droite. Vous arrivez sur `/lms/course/new` :

![Screenshot : formulaire de création de cours](screenshots/instructor-02-course-create.png)
...
Après création, vous arrivez sur `/lms/course/<id>/edit`, le shell d'édition.
...
![Screenshot : éditeur de cours, onglet Structure](screenshots/instructor-03-course-edit-structure.png)
...
![Screenshot : éditeur de bloc avec onglets de langue](screenshots/instructor-04-block-translate.png)
...
L'éditeur de leçon (`/lms/lesson/<id>/edit`) propose 8 types de blocs. Cliquez sur « Ajouter un bloc » pour ouvrir le picker :

![Screenshot : picker de type de bloc](screenshots/instructor-05-block-picker.png)
...
Onglet « Inscriptions » de `/lms/course/<id>/edit`.

![Screenshot : onglet Inscriptions](screenshots/instructor-06-enrollment-tab.png)
...
![Screenshot : zone d'invitation](screenshots/instructor-07-invite-form.png)
...
Les destinataires reçoivent un email avec un lien unique vers `/lms/course-invite/<token>`. Le lien expire dans 14 jours. Un rappel automatique est envoyé 3 jours avant expiration s'ils n'ont pas accepté.
...
![Screenshot : bouton Tout renvoyer](screenshots/instructor-08-bulk-resend.png)
...
![Screenshot : bouton publier/dépublier](screenshots/instructor-09-publish-toggle.png)
...
![Screenshot : boutons cloner/exporter/supprimer](screenshots/instructor-10-clone-export-delete.png)

## 9. Analyses du cours

Onglet « Analyses » de `/lms/course/<id>/edit`.

![Screenshot : onglet Analyses](screenshots/instructor-11-analytics.png)
...
`/lms/course/list` (bouton « Liste » en haut à droite du catalogue) — une table admin de tous les cours que vous gérez, brouillons inclus.

![Screenshot : /lms/course/list](screenshots/instructor-12-course-list.png)
