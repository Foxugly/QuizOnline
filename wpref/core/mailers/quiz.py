...
def _quiz_copy(language_code: str) -> dict[str, str]:
    if language_code == "fr":
        return {
            "greeting": "Bonjour",
            "assignment_subject": "WpRef - nouveau quiz a completer",
            "assignment_intro": "Un quiz vous a ete assigne",
            "deadline": "Deadline",
            "link": "Lien",
            "completed_subject": "WpRef - quiz cloture",
            "completed_intro": "a cloture le quiz",
        }
    if language_code == "nl":
        return {
            "greeting": "Hallo",
            "assignment_subject": "WpRef - nieuwe quiz om in te vullen",
            "assignment_intro": "Er werd een quiz aan u toegewezen",
            "deadline": "Deadline",
            "link": "Link",
            "completed_subject": "WpRef - quiz afgesloten",
            "completed_intro": "heeft de quiz afgesloten",
        }
    return {
        "greeting": "Hello",
        "assignment_subject": "WpRef - new quiz to complete",
        "assignment_intro": "A quiz has been assigned to you",
        "deadline": "Deadline",
        "link": "Link",
        "completed_subject": "WpRef - quiz completed",
