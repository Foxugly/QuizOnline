...
# Reminder fired by the J-3 sweep when a pending invitation is about to
# expire. Same recipient role as ``received`` (the invitee) so the
# per-user pref toggle is shared with the initial invitation email.
KIND_COURSE_INVITE_REMINDER = "lms.course_invite.reminder"
...
KIND_ROLE: dict[str, str] = {
    ...
    KIND_COURSE_INVITE_REMINDER: ROLE_USER,
